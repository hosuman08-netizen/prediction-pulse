...
(function(){
  ...
  function card(){
    ...
    root.innerHTML='<div class="card"><div class="chip">가상 엔터</div><div class="chip">오늘 창 '+fomoLeft()+'</div><h2 style="margin:10px 0;color:var(--gold)">'+t+'</h2><div style="font-size:42px;font-weight:800">'+score+'</div><p>'+tone+'</p><p class="sub">재미 예측 · 실투자/실결정 근거 아님</p><button id="again" style="margin-top:12px">다시 뽑기</button> <button class="sec" id="share">공유 텍스트</button></div>';
